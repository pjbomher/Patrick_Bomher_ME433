...
SOURCEFILES_QUOTED_IF_SPACED=i2c_master_noint.c HW5.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/i2c_master_noint.o ${OBJECTDIR}/HW5.o
POSSIBLE_DEPFILES=${OBJECTDIR}/i2c_master_noint.o.d ${OBJECTDIR}/HW5.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/i2c_master_noint.o ${OBJECTDIR}/HW5.o

# Source Files
SOURCEFILES=i2c_master_noint.c HW5.c
...
${OBJECTDIR}/HW5.o: HW5.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/HW5.o 
	@${FIXDEPS} "${OBJECTDIR}/HW5.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG   -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/HW5.o.d" -o ${OBJECTDIR}/HW5.o HW5.c    -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD) 
