...
SOURCEFILES_QUOTED_IF_SPACED=HW7.c i2c_master_noint.c ili9341_2.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/HW7.o ${OBJECTDIR}/i2c_master_noint.o ${OBJECTDIR}/ili9341_2.o
POSSIBLE_DEPFILES=${OBJECTDIR}/HW7.o.d ${OBJECTDIR}/i2c_master_noint.o.d ${OBJECTDIR}/ili9341_2.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/HW7.o ${OBJECTDIR}/i2c_master_noint.o ${OBJECTDIR}/ili9341_2.o

# Source Files
SOURCEFILES=HW7.c i2c_master_noint.c ili9341_2.c
...
${OBJECTDIR}/HW7.o: HW7.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/HW7.o 
	@${FIXDEPS} "${OBJECTDIR}/HW7.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG   -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/HW7.o.d" -o ${OBJECTDIR}/HW7.o HW7.c    -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD) 
