...
// INITIALIZE LCD
    ...
    IEC0bits.T3IE= 1;
        ...
        // INITIALIZE OC1
        RPA0Rbits.RPA0R=0b0101; //A0 is OC1 output
        TRISBbits.TRISB13= 0;   //B13 is PHASE
        
        T2CONbits.TCKPS = 0; // Timer2 prescaler N=1 (1:1)
        PR2 = 2399; // PR = PBCLK / N / desiredF - 1
        TMR2 = 0; // initial TMR2 and TMR3 count is 0
        T3CONbits.TCKPS = 0b110; // Timer2 prescaler N=1 (256:1)
        PR3 = 7499; // PR = PBCLK / N / desiredF - 1
        TMR3=0;
        
        OC1CONbits.OCM = 0b110; // PWM mode without fault pin; other OC1CON bits are defaults
        OC1RS = 100; // duty cycle
